...
<?php echo '<script id="LocationListTemplate" type="texFirst_Namet/x-jquery-tmpl">
    <li class="itemLocation dragableDropableItem" >
        <i class="fa fa-building"></i><div class="dd-handle"> ${LocationName} </div>
    </li>
    <ul>
        {{each location_room }}
            <li class="itemRoom dragableDropableItem" locatonId="${LocationID}" roomId="${RoomID}" >
                <i class="fa fa-hand-o-right"></i><div class="dd-handle"> ${room.RoomName} </div>
            </li>
        {{/each}}
    </ul>
</script>';?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="trainer" multiple
                                            class="filterselect table-group-action-input form-control filter">
                                        
                                        @if(!empty($all_trainer))
                                            @foreach($all_trainer as $val)
                                                <option value="{!! $val->PersonID !!}"
                                                >{!! $val->PersonName !!}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group  auto-complete-select">
                        ...
                        <div class=" col-xs-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="event_status" multiple
                                            class="filterselect table-group-action-input form-control filter ">
                ...
                <div class="row">
                    <div class="col-md-4 trainerlLocationListWrapper">
                        <h3>{!! Html::customTrans('seminarPlanner.selectTrainer') !!}
                            <a href="javascript:;" class="fa fa-info helpInfoForDragDrop" data-toggle="popover" data-trigger="focus" title="{!! Html::customTrans('seminarPlanner.infoDragTrainerHeading') !!}" data-content="{!! Html::customTrans('seminarPlanner.infoDragTrainerMessage') !!}"></a></h3>
...
<!-- reason for cancellation seminar -->
