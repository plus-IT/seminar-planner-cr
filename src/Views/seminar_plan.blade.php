...
<!--                                    <select name="planned_by" multiple
                        ...
                        <div class="col-xs-6 col-md-4">
                                <div class="form-group lineManager manager-auto-select">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            {!! Form::select2ajax('event_region',($levelID==3)?'':$LevelValueID,'filterselect table-group-action-input form-control filter', "" ,'event/getAllRBRegions',(Auth::user()->IsSuperAdmin())?'':$LevelValueID,50,1)!!}
