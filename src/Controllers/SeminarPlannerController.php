...
//        exit;
    ...
    public function index($id = "")
    {
        ...
        return view('seminar_planner.seminar_planner', compact('seminar_days_new', 'holidays', 'all_location', 'all_trainer', 'all_regions', 'all_event_category', 'all_system_user', 'id', 'currentDate'));
    }
